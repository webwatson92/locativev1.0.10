...
class BoiteVitesseForm extends Component
{
    public $code; 
    public $libelle;
    public $modelId;
    ...
    public function getModelId($modelId){
        ...
        $model = BoiteVitesse::find($this->modelId);
    ...
    public function save(){
       ...
       if($this->modelId){
            BoiteVitesse::find($this->modelId)->update($data);
       }else{
            BoiteVitesse::create($data);
       }
    ...
    public function render(){
        return view('livewire.menu.gestion.boite-vitesse-form');
    }
}
