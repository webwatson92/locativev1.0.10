...
use App\Models\{Quartier, Ville, Pays, Fournisseur, Societe, Gerant};
...
class FournisseurForm extends Component
{
    ...
    public $code, $libelle, $reg_commerce, $numero_taxe, $numero_tel, $adresse, $urlName, $newurl,
           $email, $quartier_id, $ville_id, $pays_id, $societe_id, $gerant_id, $note, $url;
    public $modelId;
    ...
    public function save(){
        if($this->currentStep == 3){
            ...
            //dd($data);
            if($this->modelId){
                    Fournisseur::find($this->modelId)->update($data);
            }else{
    ...
    public function render()
    {
        ...
        $societe = Societe::all();
        $gerant = Gerant::all();
        return view('livewire.menu.fonction.fournisseur-form',  compact("ville", "pays", "quartier", "societe", "gerant"));
    }
}
