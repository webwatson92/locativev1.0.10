<div>
    <div class="row">
        <div class="col-sm-10">
            <h1>Listes des Tarifications</h1>
        </div>
        <div class="col-sm-2">
    ...
    <div class="modal fade" id="modalForm" tabindex="-1" aria-labelledby="modalFormLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h5 class="modal-title" id="modalFormLabel">Enregistrer un pays</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                @livewire('menu.location.tarification-form')
            </div>
        </div>
        </div>
    </div>
        ...
        <table class="table align-items-center mb-0">
          ...
          <tbody> 
            ...
            <tr>
              ...
              <td>
                <p class="text-xs font-weight-bold mb-0">{{$item->valeur}}</p>
              </td>
              <td>
                <p class="text-xs font-weight-bold mb-0">@if($item->option_tarification === 1) Actif @else En attente @endif</p>
              </td>
              <td>
